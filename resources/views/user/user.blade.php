        ...
        <table class="table w-75 m-auto ">
            ...
            <thead>
                <tr class="table-dark ">
                    ...
                    <th scope="col"><button onclick="location.reload();" style="background-color: transparent; border: none; color:white;"><span class="material-symbols-outlined" >refresh</span></th></button>
                </tr>
            </thead>
            <tbody>
