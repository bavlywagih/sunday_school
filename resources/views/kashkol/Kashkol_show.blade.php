...
@section('content')
{{-- {{$kashkol->id}} --}}
            {{-- <iframe src="{{$kashkol->file}}" width="100%" height="500px"></iframe>
{{--  --}}


{{-- <div class="card d-flex">
    <div class="card-img gap-3">
        <iframe src="{{$kashkol->file}}" type="application/pdf"></iframe>
    </div>
    <div class="card-body">
        dffd
    </div>
...
<div>
    <div class="card m-auto book" id="mypdf">
        <div>
            ...
            <div>
                <iframe src="{{$kashkol->file}}" id="mypdf" style="height: 800px" class="card-img-top" width="640"  ></iframe>
            </div>
        </div>
